...
from game.primitives.init_mappings import (  # noqa: E402
    LANG_CODE,
    XLSX_PATH,
)
...
class Sense:
    # constant: NamedTuple # When used by Sensor it is regarded as Perception, when used by Emitter it is regarded as Emission
