...
SKILLS_MAPPING_BASE_SKILL_CODE_TO_CATEGORIES = MappingProxyType(dict(_excel.SKILLS_MAPPING_BASE_SKILL_CODE_TO_CATEGORIES))
...
CHARACTERISTICS_BASE_FULL_CODE_TO_STR_ALIASES = MappingProxyType(dict(_excel.CHARACTERISTICS_BASE_FULL_CODE_TO_STR_ALIASES))
