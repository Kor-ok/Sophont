...
# from game.improvedmappings.authoring import (
...
# XLSX_PATH = r"D:\Projects\Python\Sophont\game\improvedmappings\T5Mappings.xlsx"
# LANG_CODE = "en"
...
# SKILLS_MASTER_CATEGORY_CODES: Final[dict[int, StringAliases]] = load_code_to_str_aliases_from_xlsx(
#     path=XLSX_PATH,
...
# SKILLS_MAPPING_BASE_SKILL_CODE_TO_CATEGORIES: Final[dict[BaseSkillCode, CategoryCodesTuple]] = load_skill_code_to_categories_from_xlsx(
#     path=XLSX_PATH,
...
# KNOWLEDGES_BASE_KNOWLEDGE_CODES: Final[dict[int, StringAliases]] = load_code_to_str_aliases_from_xlsx(
#     path=XLSX_PATH,
...
# KNOWLEDGES_DEFAULT_KNOWLEDGE_TO_SKILLS_ASSOCIATIONS: Final[dict[BaseKnowledgeCodeInt, AssociatedSkillCodes]] = load_knowledge_to_skills_associations_from_xlsx(
#     path=XLSX_PATH,
...
# CHARACTERISTICS_MASTER_CATEGORY_CODES: Final[dict[int, StringAliases]] = load_code_to_str_aliases_from_xlsx(
#     path=XLSX_PATH,
...
# CHARACTERISTICS_BASE_FULL_CODE_TO_STR_ALIASES: Final[dict[tuple[FullCharacteristicCodeTuple, StrCodeStr], StringAliases]] = load_full_characteristic_code_to_str_aliases_from_xlsx(
#     path=XLSX_PATH,
...
# CHARACTERISTICS_MATRIX: Final[dict[tuple[FullCharacteristicCodeTuple, FullCharacteristicCodeTuple], float]] = load_characteristics_matrix_from_xlsx(
#     path=XLSX_PATH,
