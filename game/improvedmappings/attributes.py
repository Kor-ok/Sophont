...
class AttributesBase:
    ...
    :param default_canonical_alias_key_to_code: Mutable mapping of default normalized alias -> full code.
    ...
    :param custom_canonical_alias_key_to_code: Mutable mapping of custom normalized alias -> full code.
    ...
    __slots__ = (
        "default_canonical_alias_key_to_code",
        "default_view_header",
        "default_view",

        "custom_canonical_alias_key_to_code",
        "custom_view_header",
        "custom_view",
        "custom_is_dirty",
    ...
    def __new__(
        ...
        **kwargs: object,
        ...
        object.__setattr__(self, "default_canonical_alias_key_to_code", dict[CanonicalAlias, FullCode]())
        object.__setattr__(self, "default_view_header", AttributeViewHeader())
        object.__setattr__(self, "default_view", MappingProxyType(self.default_canonical_alias_key_to_code))
        ...
        object.__setattr__(self, "custom_canonical_alias_key_to_code", DirtyDict(mark_dirty=_mark_dirty))
        object.__setattr__(self, "custom_view_header", AttributeViewHeader())
        object.__setattr__(self, "custom_view", MappingProxyType(self.custom_canonical_alias_key_to_code))

        object.__setattr__(
            self, "combined_view", MappingProxyType(dict(self.default_canonical_alias_key_to_code))
        )
    ...
    def _refresh_views(self, *, force: bool = False) -> None:
        ...
        combined = {**self.default_canonical_alias_key_to_code, **self.custom_canonical_alias_key_to_code}
